...
const STATUS_CONFIG: Record<string, { label: string; bg: string; dot: string }> = {
  ...
  partial: { label: 'Partial', bg: 'bg-blue-50 text-red-700 dark:bg-blue-900/20 dark:text-red-400', dot: 'bg-blue-400' },
  unpaid: { label: 'Unpaid', bg: 'bg-blue-50 text-red-700 dark:bg-blue-900/20 dark:text-red-400', dot: 'bg-blue-400' },
}
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center gap-6">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">School Fee Collection Overview</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:w-64">
            {[
              ...
              { label: 'Collected', value: fmt(stats.totalCollected), icon: TrendingUp, accent: 'bg-blue-500/20' },
              { label: 'Arrears', value: fmt(stats.outstanding), icon: TrendingDown, accent: 'bg-blue-400/20' },
