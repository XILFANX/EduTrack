            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select value={subjectId} onChange={e => setSubjectId(e.target.value)}
                  className="w-full bg-background border border-border text-foreground rounded-xl px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500/50">
      ...
      {slots.length > 0 && !published && (
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-4 flex items-center justify-between">
          ...
          <button
            ...
            disabled={publishing}
            className="flex items-center gap-2 px-4 py-2 bg-white text-blue-700 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors disabled:opacity-60"
          >
