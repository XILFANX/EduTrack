  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-3xl mx-auto pb-32">
      ...
      <div className="text-center py-20 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl">
        ...
        <h2 className="text-lg font-semibold text-foreground">Billing portal coming soon</h2>
        <p className="text-sm text-muted-foreground max-w-sm mx-auto mt-2">
          You are currently on the trial tier. Premium billing management will be available here soon.
        </p>
      </div>
    </div>
  )
