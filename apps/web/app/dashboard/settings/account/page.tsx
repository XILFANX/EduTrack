...
export default async function AccountSettingsPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-3xl mx-auto pb-32">
      ...
      <div className="bg-white dark:bg-[#060d1a] border border-slate-200 dark:border-[#1a2744] rounded-xl p-6 shadow-sm">
      ...
      <div className="bg-blue-50 dark:bg-blue-950/20 border border-red-200 dark:border-red-900/40 rounded-xl p-6 shadow-sm">
        <h2 className="text-red-600 dark:text-red-400 font-semibold mb-2">Danger Zone</h2>
        <p className="text-sm text-blue-800 dark:text-red-300 mb-4">
