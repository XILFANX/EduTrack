...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-[#060d1a] dark:to-[#0c1a2e] flex items-center justify-center px-4">
        ...
        <div className="bg-white dark:bg-[#060d1a] rounded-2xl shadow-sm border border-slate-100 dark:border-[#1a2744] p-6 space-y-4">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-all text-sm disabled:opacity-60 shadow-md shadow-blue-500/20"
            >
