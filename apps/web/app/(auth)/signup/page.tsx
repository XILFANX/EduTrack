    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <Link href="/login" className="text-blue-600 dark:text-blue-600 text-sm hover:underline">Back to login</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* Card */}
        <div className="bg-white dark:bg-[#060d1a] rounded-2xl shadow-sm border border-slate-100 dark:border-[#1a2744] p-6 space-y-4 relative z-10">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            {error && (
              <p className="text-sm text-red-600 dark:text-red-400 bg-blue-50 dark:bg-blue-950/50 border border-red-100 dark:border-red-900/50 px-3 py-2 rounded-lg leading-snug">
                {error}
              </p>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#1D6FEB] hover:bg-[#1558C8] text-white font-medium py-2.5 px-4 rounded-lg transition-colors text-sm disabled:opacity-60"
            >
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400">
          ...
          <Link href="/login" className="text-blue-600 dark:text-blue-600 font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
