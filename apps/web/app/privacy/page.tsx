...
export const metadata = {
  ...
  description: 'Learn how EduTrack collects, uses, and protects your personal data. We are GDPR-aware and give school admins full control to export or delete their portfolio data at any time.',
  keywords: ['EduTrack privacy', 'school data privacy', 'GDPR school software', 'data deletion property management', 'student data rights'],
  openGraph: {
    title: 'Privacy Policy | EduTrack',
