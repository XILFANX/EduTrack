                      ...
                      return (
                        <li key={guide.slug}>
                          <Link 
                            ...
                            onClick={() => setIsOpen(false)}
                            className="flex items-center gap-3 px-3 py-2 text-sm rounded border border-transparent hover:bg-zinc-900 hover:border-zinc-800 hover:text-blue-500 transition-all text-zinc-400 group"
                          >
