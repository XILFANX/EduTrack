            ...
            >
              <div className="md:col-span-5 flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="text-sm font-bold text-foreground truncate transition-colors group-hover:text-blue-600 dark:group-hover:text-cyan-400">
                      {s.name}
                    </p>
                  </div>
              ...
              <div className="md:col-span-2 flex items-center justify-between md:justify-end">
                ...
                <div className="flex flex-col items-end">
                  <span className="text-sm font-bold text-foreground group-hover:text-blue-600 dark:group-hover:text-cyan-400 transition-colors">
