    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6 md:gap-8">
          ...
          {/* Recent Signups */}
          <div className="bg-white dark:bg-[#060d1a]/80 border border-border rounded-3xl overflow-hidden shadow-sm flex flex-col">
            <div className="px-6 py-5 border-b border-border flex items-center justify-between bg-slate-50/50 dark:bg-[#0d1b2e]/20">
            ...
            {!recentSchools || recentSchools.length === 0 ? (
              <div className="px-6 py-16 flex flex-col items-center justify-center text-center">
                <div className="w-16 h-16 bg-slate-100 dark:bg-[#0d1b2e] rounded-full flex items-center justify-center mb-4">
              ...
              <div className="divide-y divide-border/50">
                {recentSchools.map((s) => (
                  <Link key={s.id} href={`/admin/schools`} className="flex items-center justify-between px-6 py-4 hover:bg-slate-50 dark:hover:bg-[#0d1b2e]/80 transition-colors group">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm font-bold text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">{s.name}</p>
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          {/* Quick Actions */}
          <div className="bg-white dark:bg-[#060d1a]/80 border border-border rounded-3xl p-6 shadow-sm relative overflow-hidden">
              ...
              {[
                ...
                return (
                  <Link key={a.href} href={a.href}
                    ...
                    <Icon className="w-5 h-5 text-blue-600 group-hover:text-blue-600 transition-colors" />
                    {a.label}
                  </Link>
                )
              })}
          ...
          <div className="bg-white dark:bg-[#060d1a]/80 border border-border rounded-3xl overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="divide-y divide-border/50">
              ...
              {adminUsers?.slice(0, 3).map((a) => (
                <div key={a.id} className="flex items-center gap-4 px-6 py-4">
                  <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-[#0d1b2e] text-slate-600 dark:text-slate-300 text-sm font-bold flex items-center justify-center shrink-0 border border-slate-200 dark:border-[#1a2744]">
            ...
            <div className="p-4 border-t border-border bg-slate-50 dark:bg-[#060d1a]/80">
              <Link href="/admin/admins"
                className="flex items-center justify-center w-full bg-white dark:bg-[#0d1b2e] border border-slate-200 dark:border-[#1a2744] hover:border-cyan-300 dark:hover:border-cyan-700 hover:text-blue-600 dark:hover:text-blue-400 text-sm font-bold text-slate-700 dark:text-slate-300 py-3 rounded-xl transition-all shadow-sm">
                Manage Team
              </Link>
            </div>
          </div>
