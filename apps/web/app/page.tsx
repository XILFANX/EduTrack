...
// ─── Theme tokens (electric blue / cyan — EduTrack) ────────────────────────
const T = {
  accent:       'text-blue-600 dark:text-blue-400',
  accentHover:  'hover:text-blue-600 dark:hover:text-blue-400',
  bg:           'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700',
  ...
  const portals = [
    {
      ...
      cta: 'Create free account', href: '/signup', ctaStyle: 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-md shadow-blue-500/20', secondary: null,
    },
    {
      ...
      cta: 'Use invite link', href: '/login', ctaStyle: 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-md shadow-blue-500/20',
    ...
    },
    {
      ...
      cta: 'Sign in to your portal', href: '/login', ctaStyle: 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-md shadow-blue-500/20',
