        ...
        <div className="relative flex items-center justify-around p-2">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-1">
                  ...
                  <span className={`text-[10px] font-semibold tracking-tight transition-colors duration-300 ${active && !menuOpen ? 'text-white/90' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'
                    }`}>
                    {t.label}
                  </span>
                </div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-1">
              ...
              <span className={`text-[10px] font-semibold tracking-tight transition-colors duration-300 ${isMenuActive || menuOpen ? 'text-white/90' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'
                }`}>
                More
              </span>
            </div>
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`text-xs font-bold text-center mt-1 transition-colors ${active ? 'text-blue-600 dark:text-blue-400' : 'text-foreground group-hover:text-blue-600'}`}>
                            {item.label}
                          </span>
                        </Link>
                      )
