...
function PricingCard({ tier, price, description, features, highlighted = false, isAnnual = false }: {
  ...
  return (
    <div className={`relative p-6 rounded-2xl flex flex-col ${highlighted ? 'bg-cyan-600 border border-cyan-500 shadow-xl z-10 text-white ring-2 ring-cyan-500 ring-offset-2 dark:ring-offset-slate-950' : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white'}`}>
      {highlighted && (
    ...
    <section id="pricing" className="py-14 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyan-50 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 text-xs font-medium mb-4 border border-cyan-200 dark:border-cyan-500/20">
            Pricing
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            ...
            <button
              ...
              className="relative inline-flex h-6 w-11 items-center rounded-full bg-cyan-600 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-offset-2 dark:focus:ring-offset-slate-950"
            >
              <span
            ...
            <span className={`text-sm font-medium ${isAnnual ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}>
              Annually <span className="text-cyan-600 dark:text-cyan-400 font-bold ml-1">Save 17%</span>
            </span>
          </div>

          <div className="mt-6 p-3 bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-100 dark:border-cyan-500/20 rounded-xl inline-block">
