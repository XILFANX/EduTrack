        ...
        <div className="flex flex-col gap-2 px-5 py-4 border-t border-slate-100 dark:border-[#1a2744] mt-2">
          {expanded ? (
            <div className="flex gap-2">
              {(pending.action_href || pending.link) && (
                <Link
                  ...
                  onClick={handleDismiss}
                  className="flex-1 bg-[#1D6FEB] hover:bg-[#1558C8] text-white text-sm font-bold py-2.5 rounded-xl text-center transition-colors flex items-center justify-center gap-2"
                >
            ...
            <div className="flex gap-2">
              <button
                onClick={handleRead}
                className="flex-1 bg-[#1D6FEB] hover:bg-[#1558C8] text-white text-sm font-bold py-2.5 rounded-xl transition-colors flex items-center justify-center gap-1"
              >
