  ...
  return (
    <div className="space-y-4">
      {announcements.map((ann) => {
        ...
        return (
          <div key={ann.id} className="relative bg-[#0b0f19] border border-blue-500/20 rounded-2xl p-5 overflow-hidden group hover:border-blue-500/40 transition-colors shadow-lg">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-3 mb-3">
              <h3 className="font-bold text-blue-400 text-lg group-hover:text-blue-300 transition-colors">
                {ann.title}
              </h3>
              <div className="flex items-center gap-3 text-xs font-semibold text-blue-200/60">
                <span className="bg-blue-500/10 text-blue-400 border border-blue-500/20 px-2.5 py-1 rounded-lg">
